...
const OutboundItemScanModal = React.memo((props: ScanModalProps) => {
  ...
  const { toggleSourceScanning } = useModalHooks();
  ...
  if (item) {
    return (
      <Modal
        visible={visible}
        onRequestClose={toggleSourceScanning}
        transparent
      >
        {status === "success" && (
          <MessageToast
          ...
          <View style={styles.modalView}>
            ...
            <ScrollView contentContainerStyle={{ gap: 12 }}>
              <View style={styles.headerContainer}>
                <TouchableOpacity onPress={toggleSourceScanning}>
              ...
              <View style={styles.item}>
                ...
                <View style={format.twoRowText}>
                  ...
                  <Text>{` ${
                    item.mfgdte
                      ? formatDateStringMMDDYYYY(item.mfgdte)
                      : "No Date"
                  } `}</Text>
                </View>
                <View style={format.twoRowText}>
